...
<tr><td><label><?php echo "Directory";?></label><td><input type="text" name="dir" id="dir"  value="<?php echo $_POST['dir'] ?>"/><label class="suggestion-string">Enter directory path e.g. app/code/Brainvire</label></td></tr>
